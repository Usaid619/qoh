...
const Recommendation = () => {
 ...
 text-center">Handpicked Favourites, Just For you!</span>
        </div>
              ...
              {recommendedList?.map((item) => (
                ...
                >
                  <Link href={`/shop?recommended=${item?.name?.toLowerCase()}`} className="flex  justify-center flex-col items-center">
                    <div className="w-14  h-14 lg:w-[120px] lg:h-[120px]  md:w-[8.2vw] md:h-[8.2vw] rounded-full bg-[#e7e7e7] flex items-center justify-center">
